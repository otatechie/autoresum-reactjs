                                ...
                                {isEditing ? (
                                    <div className="space-y-4">
                                        <input
                                            ...
                                            className="w-full px-4 py-2 text-lg font-semibold text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500"
                                        />
                                        <textarea
                                            name="bio"
                                            value={userData.bio}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full px-4 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                                        >
                            ...
                            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6">
                                ...
                                <div className="space-y-4">
                                    <Link 
                                        to="/change-password"
                                        className="w-full inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700"
                                    >
                                        Change password
                                    </Link>
                                    <button className="w-full inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-lg border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/40">
                                        Delete account
                                    </button>
                                </div>
                            </div>
