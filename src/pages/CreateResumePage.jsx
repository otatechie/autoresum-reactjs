    ...
    return (
        <>
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <form id="resume-form" className="space-y-8">
                    ...
                    <FormSection title="Work Experience">
                        <div className="flex justify-end mb-6">
                            <button type="button" className="btn-primary text-sm px-4 py-2 rounded-lg flex items-center gap-x-2">
                        ...
                        <div className="space-y-6">
                            <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 relative group shadow-sm hover:shadow-md transition-shadow">
                                <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button type="button" className="text-gray-400 hover:text-red-500 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <textarea name="job_description[]" rows="4" placeholder="Describe your responsibilities and achievements" className="form-control mb-2"></textarea>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    <input type="text" name="skills" placeholder="Type a skill and press Enter" className="form-control" />
